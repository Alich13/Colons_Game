...
int main()
{
    ...
    intersection_map.update_intersection_state(7, States::p1);
    ...
    intersection_map.update_route_state(I2, I1, States::p1);


    

    node first_click = I3;
    node second_click = I5;
    /*checks*/
    if (intersection_map.check_possible_route(first_click, second_click, States::p1))
        {
                intersection_map.update_route_state(first_click, second_click, States::p1);
                cout <<"----------updated----------"<<endl;
        }
